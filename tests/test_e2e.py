...
def test_resume_name_is_correct(page: Page):
...
def test_industrial_hardware_skills(page: Page):
    page.goto("http://localhost:8081")
...
def test_commissioning_manager_experience(page: Page):
    page.goto("http://localhost:8081")
...
def test_commissioning_engineer_experience(page: Page):
    page.goto("http://localhost:8081")
...
def test_electrical_designer_experience(page: Page):
    page.goto("http://localhost:8081")
...
def test_boiler_technician_experience(page: Page):
    page.goto("http://localhost:8081")
...
def test_navy_experience(page: Page):
    page.goto("http://localhost:8081")
...
def test_AWS_education(page: Page):
    ...
    expect(page.get_by_text("Mar 2023")).to_be_visible()
...
def test_navy_education(page: Page):
    page.goto("http://localhost:8081")
    expect(page.get_by_text("Naval Nuclear Power School @ NTC Orlando, Fl")).to_be_visible()
    expect(page.get_by_text("Jul 2000 – Dec 2000")).to_be_visible()
